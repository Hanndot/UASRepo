...
class MyWindow(Window):
    ...
    def button_Click(self, sender, e):
        ...
        if self.combo2.Text == None:
           MessageBox.Show("Belum Diisi")
        else:
            if self.combo2.Text == self.combo1.Items.GetItemAt(0).ToString():
                y = 'a'
            elif self.combo2.Text == self.combo1.Items.GetItemAt(1).ToString():
                y = 'b'    
            elif self.combo2.Text == self.combo1.Items.GetItemAt(2).ToString():
                y = 'c'    
            elif self.combo2.Text == self.combo1.Items.GetItemAt(3).ToString():
                y = 'd'    
            elif self.combo2.Text == self.combo1.Items.GetItemAt(4).ToString():
                y = 'e'    
            elif self.combo2.Text == self.combo1.Items.GetItemAt(5).ToString():
                y = 'f'    
            elif self.combo2.Text == self.combo1.Items.GetItemAt(6).ToString():
                y = 'g'
